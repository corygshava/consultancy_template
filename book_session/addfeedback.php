<?php
	...
	$success_message = "session booking requested, we'll get back to via the details given"; // what will be shown if it works
	$backpage = "index.php";		// where to go back to
	...
	if (isset($_POST['theemail'],$_POST['thesubject'],$_POST['themsg'])) {
		...
		try{
			...
			$heading = "Request recieved";
			$outTxt = $success_message;
